...
class IPlotyPlot(metaclass=ABCMeta):
...
class CompositePlot(IPlot):
    
    def __init__(self):
        """Constrcut empty list which will hold child plots."""
        self.child_plots = []
    
    def add(self, plot):
        """Add child plots"""
        self.child_plots.append(plot)
...
class CompositePlotlyPlot(IPlot):
...
class PlotlyInterventionsPlot(IPlotyPlot):
...
class PlotlySimPlot(IPlotyPlot):           
...
class PlotlyPeoplePlot(IPlotyPlot):         
